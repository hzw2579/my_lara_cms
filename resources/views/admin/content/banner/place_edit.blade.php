            ...
            <div class="layui-card">
                <div class="layui-form" wid100 lay-filter="" id="layuiadmin-app-form-tags">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="height"  lay-verify="number" value="{{$info->height}}" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">宽度</label>
                        <div class="layui-input-block">
                            <input type="text" name="width"  lay-verify="number" value="{{$info->width}}" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(*)', function(data){
            ...
            $ = layui.$;
            $.ajax({
                url: "/admin/banner_place/{{$info->id}}",
                type: "post",
                async: false,
                cache: false,
                data: data.field,
