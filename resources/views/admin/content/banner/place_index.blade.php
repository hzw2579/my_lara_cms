...
<script>
    layui.use(['table','layer'],function(){
        ...
        table.render({
            elem: '#demo'
            ,height: 'full-170'
            ,url: "{{url('admin/banner_place_ajax_list')}}" //数据接口
        ...
        function edit_ajax(id){
            layer.open({
                ...
                maxmin: true,
                offset: 't',
                content: "/admin/banner_place/"+id+"/edit",
                end:function () {
                    table.reload('demo');
                }
            });
        ...
        function add(){
            layer.open({
                ...
                maxmin: true,
                offset: 't',
                content: '{{url('admin/banner_place/create')}}',
                //关闭是的回调函数
                end: function () {
                    table.reload('demo');
                }
