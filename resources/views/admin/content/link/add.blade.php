            ...
            <div class="layui-card">
                <div class="layui-form" wid100 lay-filter="lay-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="url" value="" class="layui-input" lay-verify="required|url">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">打开方式</label>
                        <div class="layui-input-block">
                            <input type="radio" name="target" value="1" title="新开窗口" checked>
                            <input type="radio" name="target" value="0" title="当前窗口">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-md8">
                            <input type="text" name="image"  value="" class="layui-input">
                        </div>
