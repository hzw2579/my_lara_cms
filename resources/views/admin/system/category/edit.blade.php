            ...
            <div class="layui-card">
                <div class="layui-form" wid100 lay-filter="lay-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="pid" lay-verify="required" lay-filter="" lay-search>
                                <option @if($info->pid == 0)selected @endif value="0">顶级菜单</option>
                                @foreach($list as $v)
                                    <option @if($info->pid == $v['id'])selected @endif value="{{$v['id']}}">{{str_repeat("|----",$v['level']-1)}}{{$v['name']}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="account" placeholder="" class="layui-textarea">{{$info->account}}</textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-md8">
                            <input type="text" name="icon"  value="{{$info->icon}}" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item" style="text-align:center;">
                        <img id="icon"  src="{{$info->icon}}" style="width: 300px;">
                    </div>
                    <div class="layui-form-item">
