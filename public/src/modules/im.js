...
;layui.define(["index", "layim"], function (e) {
    ...
    t.config({
        ...
        initSkin: "3.jpg",
        msgbox: "../start/layui/css/modules/layim/html/msgbox.html",
        find: "../start/layui/css/modules/layim/html/find.html",
        chatLog: "../start/layui/css/modules/layim/html/chatlog.html"
    ...
    var a = layui.jquery, i = {
        chat: function () {
            ...
            var e = layui.device(), a = "layui/css/modules/layim/html/mobile.html";
            ...
            layer.photos({
                photos: {data: [{src: "http://139.196.96.28:8080/layui/upload/2016_12/168_1481056358469_50288.png"}]},
                anim: 0,
                shade: !1,
                success: function (e) {
